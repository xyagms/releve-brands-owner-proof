...
{
    wp_enqueue_style('releve-brands-main', get_template_directory_uri() . '/assets/css/main.css', [], '2.3.0');
    wp_enqueue_script('releve-brands-main', get_template_directory_uri() . '/assets/js/main.js', [], '2.3.0', true);
}
